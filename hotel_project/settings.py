...
SESSION_COOKIE_NAME = 'sessionid'  # Default, digunakan oleh aplikasi
SESSION_COOKIE_PATH = '/'  # Pastikan sesi berlaku untuk seluruh situs
...
MIDDLEWARE = [
    ...
    'reservasi_backend.middleware.AppAuthMiddleware',   
